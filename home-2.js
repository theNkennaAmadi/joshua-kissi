  ...
  ScrollTrigger.create({
    ...
    onLeave: () => {
      if (section.querySelector(".m-img")) {
        document.querySelector(
          ".bg-background"
        ).style.backgroundImage = section.parentElement.nextElementSibling.querySelector(
          ".hp-section-bg"
        ).style.backgroundImage;
      }
      if (
    ...
    onLeaveBack: () => {
      if (section.querySelector(".m-img")) {
        document.querySelector(
          ".bg-background"
        ).style.backgroundImage = section.parentElement.previousElementSibling.querySelector(
          ".hp-section-bg"
        ).style.backgroundImage;
      }
